  ...
  return (
    <div className="relative">
      <select
        ...
        className={cn(
          "border-input selection:bg-primary selection:text-primary-foreground dark:bg-input/30 dark:text-foreground dark:[&>option]:bg-card dark:[&>option]:text-foreground h-9 w-full min-w-0 appearance-none rounded-md border bg-transparent px-3 py-1 pr-10 text-base shadow-xs transition-[color,box-shadow] outline-none disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
